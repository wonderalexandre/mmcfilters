...
struct ContourTraceDeltaStore {
    ...
    explicit ContourTraceDeltaStore(int numNodes = 0)
     ...
     */
    static ContourTraceDeltaStore fromPendingEdgeLists(
        const PendingPixelLists& additions,
