 ...
 */
inline void updateLargestAreaAttributeDeltaDescendant(
...
inline void validateAttributeDeltaAltitudeBufferShape(const MorphologicalTree& tree, std::span<const T> altitude) {
 ...
 */
template<AltitudeValue T>
inline T attributeDeltaAltitudeAt(std::span<const T> altitude, NodeId nodeId) {
 ...
 */
template<AltitudeValue T>
inline void validateAltitudeDelta(AltitudeDiff<T> delta, const char* context) {
 ...
 */
template<AltitudeValue T>
inline NodeId findAscendantByAltitudeDelta(
    const MorphologicalTree& tree,
 ...
 */
template<AltitudeValue T>
inline std::pair<std::vector<NodeId>, std::vector<NodeId>> computeAscendantsAndDescendantsByAltitude(
    const MorphologicalTree& tree,
    std::span<const T> altitude,
    AltitudeDiff<T> delta) {
    validateAttributeDeltaAltitudeBufferShape(tree, altitude);
