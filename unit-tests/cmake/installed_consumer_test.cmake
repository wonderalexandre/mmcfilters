...
"    mmcfilters::sdrt::SaturatedResidualTreeBuilder<std::uint8_t> saturatedBuilder(residualAdjacency, mmcfilters::NodeId{0});\n"
...
"    assert(unrestrictedBuilder.getTiePolicy() == mmcfilters::sdrt::SdrtTiePolicy::ContrastInvariantSpatial);\n"
"    assert(saturatedBuilder.getInfinityPixel() == 0);\n"
"    auto residualTree = mmcfilters::MorphologicalTreeFactory::createSelfDualResidualTree(image, 1.0, unrestrictedOptions);\n"
"    auto saturatedResidualTree = mmcfilters::MorphologicalTreeFactory::createSaturatedSelfDualResidualTree(image, mmcfilters::NodeId{0}, 1.0, saturatedOptions);\n"
