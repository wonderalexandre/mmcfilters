...
"        tree.topology(),\n"
"        std::vector<mmcfilters::AttributeOrGroup>{mmcfilters::Attribute::Area, mmcfilters::Attribute::BoxWidth});\n"
...
"    auto publicMaxDist = mmcfilters::AttributeComputation::computeSingleAttribute(tree, mmcfilters::Attribute::MaxDist);\n"
...
"    struct InstalledLocalRule {\n"
"        using Value = int;\n"
"        Value additiveIdentity() const { return 0; }\n"
"        Value evaluateLocalRule(mmcfilters::local_attributes::BinaryVisibilityState state) const { return static_cast<int>(state.bits()); }\n"
...
"    };\n"
"    static_assert(mmcfilters::local_attributes::LocalRule<InstalledLocalRule>);\n"
"    const InstalledLocalRule installedLocalRule;\n"
"    auto eventDeltas = mmcfilters::local_attributes::FiniteWindowLocalAttributeComputer::computeEventDeltas(\n"
"        tree.topology(), 0, observationWindow, installedLocalRule);\n"
...
"        tree.topology(), observationWindow, installedLocalRule);\n"
"    auto nodeAttributes = mmcfilters::local_attributes::FiniteWindowLocalAttributeComputer::aggregateLocalAttributeIncrements(\n"
"        tree.topology(), std::span<const mmcfilters::local_attributes::LocalAttributeIncrement<int>>(localAttributeIncrements), installedLocalRule);\n"
