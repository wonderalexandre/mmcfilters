...
class UltimateAttributeOpeningCT;
using UltimateAttributeOpeningCTPtr = std::shared_ptr<UltimateAttributeOpeningCT>;
class UltimateAttributeOpeningCT{
  ...
  protected:
    ...
    void execute(int maxCriterion, std::vector<uint8_t> selectedForFiltering){
  ...
  public:
    ...
    UltimateAttributeOpeningCT(ComponentTreePtr tree,  std::shared_ptr<float[]> attrs_increasing): UltimateAttributeOpeningCT(tree.get(), std::move(attrs_increasing)) {}
    UltimateAttributeOpeningCT(ComponentTree* tree, std::shared_ptr<float[]> attrs_increasing){
      this->tree = tree;
